const teamData = [
  ...
  },
  {
    ...
    name: 'Andrie Moral',
    role: 'Frontend Developer',
    description: 'Passionate about crafting responsive, user-friendly web experiences using modern tools and technologies.',
    image: '/img/moral.jpg',
    social: {
    ...
    skills: {
      ...
      tools: [
        { name: 'Figma', mastery: 80 },
        { name: 'Vscode', mastery: 85 },
        { name: 'Bootstrap', mastery: 40 }
      ]
    },
    projects: [
      {

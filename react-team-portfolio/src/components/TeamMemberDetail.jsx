...
const TeamMemberDetail = ({ name, role, description, image, skills, projects, social }) => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      {/* Back Navigation */}
      <div className="fixed top-0 left-0 right-0 bg-white dark:bg-gray-800 shadow-lg z-[100]">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="h-16 flex items-center justify-between">
            <Link to="/" className="text-gray-700 dark:text-gray-300 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors flex items-center">
            ...
            <Link to="/" className="flex items-center" aria-label="Home">
              <img 
                ...
                className="h-16 w-16 sm:h-20 sm:w-20 transition-all hover:scale-105 duration-300 dark:invert" 
              />
            </Link>
          </div>
        </div>
              ...
              <div className="text-center">
                ...
                <div className="space-y-4" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div className="flex justify-center space-x-6">
                    {teamData.find(member => member.name === name)?.social?.github && (
                      <a 
                    ...
                    {teamData.find(member => member.name === name)?.social?.facebook && (
                      <a 
                    ...
                    {teamData.find(member => member.name === name)?.social?.linkedin && (
                      <a 
                        href={teamData.find(member => member.name === name)?.social?.linkedin} 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-gray-700 dark:text-gray-300 hover:text-primary-500 dark:hover:text-primary-400 transition-colors"
                        aria-label="LinkedIn"
                    ...
                    {teamData.find(member => member.name === name)?.social?.twitter && (
                      <a 
                        href={teamData.find(member => member.name === name)?.social?.twitter} 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-gray-700 dark:text-gray-300 hover:text-primary-500 dark:hover:text-primary-400 transition-colors"
                        aria-label="Twitter"
